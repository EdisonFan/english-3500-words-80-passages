...
const SRC = path.join(__dirname, 'data', 'renjiao', 'sel3_source.md');
const BOOK_DIR = path.join(__dirname, 'data', 'renjiao', 'sel3');
const PASSAGES_DIR = path.join(BOOK_DIR, 'passages');

const BOOK_ID = 'sel3';
const BOOK_TITLE = '高中英语 选择性必修第三册';
const BOOK_SUBTITLE = '人教版 (2019 版)';
const BOOK_COLOR = '#7A4E8C';   // 深紫,与 3500 蓝 / pep1 紫 / pep2 绿 / pep3 橙红 / sel1 钢蓝区分
