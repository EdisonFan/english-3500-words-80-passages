#!/usr/bin/env node
/**
 * 解析人教版 PEP3 源 markdown，生成 data/renjiao/pep3/ 数据结构
 *
 * 源格式（与 PEP2 相同）：
 *   ## Unit N - TITLE 中文标题
...
const SRC = path.join(__dirname, 'data', 'renjiao', 'pep3_source.md');
const BOOK_DIR = path.join(__dirname, 'data', 'renjiao', 'pep3');
const PASSAGES_DIR = path.join(BOOK_DIR, 'passages');

const BOOK_ID = 'pep3';
const BOOK_TITLE = '高中英语 必修第三册';
const BOOK_SUBTITLE = '人教版 (2019 版)';
const BOOK_COLOR = '#D9644B';   // 橙红色,与 3500 蓝 / pep1 紫 / pep2 绿区分

/* 单元顺序：按文件出现顺序 */
const UNIT_TITLES = {
    1: 'Festivals and Celebrations 节日与庆祝',
    2: 'Morals and Virtues 道德与美德',
    3: 'Diverse Cultures 多元文化',
    4: 'Space Exploration 太空探索',
    5: 'The Value of Money 金钱的价值',
};
...
function main() {
    ...
    const book = {
        ...
        cover: null,
        color: BOOK_COLOR,
        desc: '人民教育出版社 2019 版高中英语必修第三册,10 篇主课文 + 单元单词表',
