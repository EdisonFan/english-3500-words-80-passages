...
var TOTAL = 5;  // 必修二 5 个单元

/* === 必修二 5 个单元 === */
var UNITS = [
    { num: 1,  title: 'Cultural Heritage',      start: 1, end: 1 },
    { num: 2,  title: 'Wildlife Protection',    start: 2, end: 2 },
    { num: 3,  title: 'The Internet',           start: 3, end: 3 },
    { num: 4,  title: 'History and Traditions', start: 4, end: 4 },
    { num: 5,  title: 'Music',                  start: 5, end: 5 }
];
...
function renderHome() {
    var html = '<div class="home">' +
        '<div class="home-head"><h1>人教版 <em>必修二</em></h1>' +
        '<p>5 篇精读 · Reading and Thinking · 单词下方带上下文释义</p></div>';
